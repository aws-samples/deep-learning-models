...
def get_base_model(model_name, weights_path, weight_decay=1e-4):
    ...
    if model_name == 'VGG16':
        ...
        base_model = mmdet.models.backbones.ResNet50(weights=None, include_top=False, weight_decay=weight_decay)
    elif model_name == 'ResNet50V2':
        base_model = mmdet.models.backbones.ResNet50V2(weights=None, include_top=False, weight_decay=weight_decay)
